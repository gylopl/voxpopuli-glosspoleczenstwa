package makdroid.voxpopuli.google;
...
public class GooglePlusSignIn {
    ...
    public GooglePlusSignIn(FragmentActivity mActivity, InfoLoginGoogleCallback googleCallback) {
