package makdroid.voxpopuli.utils.piechart;
 ...
 */
public class PieChartVP extends PieRadarChartBase<PieData> {

    private Drawable mCenterImage;
    private boolean mDrawCenterImage = true;
    private int mMarginImage = 30;
    ...
    public PieChartVP(Context context) {
        super(context);
    }

    public PieChartVP(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PieChartVP(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new PieChartRendererVP(this, mAnimator, mViewPortHandler);
        mXAxis = null;
    }
    ...
    public void setHoleColor(int color) {
        ((PieChartRendererVP) mRenderer).getPaintHole().setColor(color);
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((PieChartRendererVP) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((PieChartRendererVP) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((PieChartRendererVP) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setCenterTextColor(int color) {
        ((PieChartRendererVP) mRenderer).getPaintCenterText().setColor(color);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((PieChartRendererVP) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((PieChartRendererVP) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof PieChartRendererVP) {
            ((PieChartRendererVP) mRenderer).releaseBitmap();
        }
        super.onDetachedFromWindow();
    }


    public Drawable getmCenterImage() {
        return mCenterImage;
    }

    public void setmCenterImage(Drawable mCenterImage) {
        this.mCenterImage = mCenterImage;
    }

    public boolean ismDrawCenterImage() {
        return mDrawCenterImage;
    }

    public void setmDrawCenterImage(boolean mDrawCenterImage) {
        this.mDrawCenterImage = mDrawCenterImage;
    }

    public int getmMarginImage() {
        return mMarginImage;
    }

    public void setmMarginImage(int mMarginImage) {
        this.mMarginImage = mMarginImage;
    }
}
