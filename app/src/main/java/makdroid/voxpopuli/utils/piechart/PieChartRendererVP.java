 ...
 */
public class PieChartRendererVP extends DataRenderer {

    protected PieChartVP mChart;
    ...
    private Drawable mCenterImageLastValue;
    private RectF mCenterTextLastBounds = new RectF();
    private Rect mCenterImageLastBounds = new Rect();
    ...
    public PieChartRendererVP(PieChartVP chart, ChartAnimator animator,
...
//                }
     ...
     * sense when center-hole is enabled
     */
    protected void drawCenterImage(Canvas c) {

        Drawable centerImage = mChart.getmCenterImage();
        int a = centerImage.getMinimumHeight();
        int b = centerImage.getIntrinsicHeight();

        if (mChart.ismDrawCenterImage() && centerImage != null) {
            ...
            boundingRect.inset(mChart.getmMarginImage(), mChart.getmMarginImage());

            if (!centerImage.equals(mCenterImageLastValue) || !boundingRect.equals(mCenterImageLastBounds)) {

                Rect rect = new Rect();
                boundingRect.round(rect);
                mCenterImageLastBounds.set(rect);
                mCenterImageLastValue = centerImage;
                mCenterImageLastValue.setBounds(rect);
